...
for %%t in ("input\*.*") DO ffmpeg -r 1 -f image2 -s 1280x720 -y -i "temp1\%%~nt_%%3d.png" -i "overlays/n.png" -filter_complex "[0:v]scale=1280:720[vvid];[vvid][1:v]overlay=0:0" -preset ultrafast "temp2\%%~nt.mp4"
